import { EReasonCodesStatic } from "../../src/enum/generlaEnum";
import { EContextLayerDatasets, EFetchMethods } from "../../src/enum/gfwEnum";
...
export const eventSchema_umatched_near_coast: any = {
    ...
    "run_metadata": {
      ...
      "config_hash": "1e9584ccfd82f114fda158e04431edd7188a905602984e70ced01f73d1f08689"
    },
    "context_layers": {
      "EEZ": {
        "dataset": "public-eez-areas",
...
export const eventSchema_matched_without__port_event: any = {
  "version": "1.0.0",
  ...
  "run_metadata": {
    ...
    "config_json": [
      ...
      },
      {
        ...
        "body_params": {
          ...
          "startDate": "2025-12-01T00:00:00Z",
          "vessels": [
            "3b60c55c1-15dd-0f53-dfd5-edb954370ccb"
          ]
        },
        "method": "POST",
        "source": "public-global-port-visits-events:v3.0",
    ...
    "config_hash": "3027b6de80f3e47fc1722f258f502d4aeccbc9064884d37dbaff54f07bd48d74"
  },
  "context_layers": {
    "EEZ": {
      "dataset": "public-eez-areas",
...
export const eventSchema_inWater: IEventSchema = {
  ...
  "run_metadata": {
    ...
    "config_hash": "eda7be49553768acc660b9bd6a10be10a6ee481493359ac78ded17d315ce9145"
  },
  "context_layers": {
    "EEZ": {
      "dataset": EContextLayerDatasets.eez,
