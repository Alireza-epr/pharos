...
const HeaderPanel = (props: HeaderPanelProps) => {
  ...
  return (
    <div className={` ${headerPanelStyle.wrapper}`}>
      ...
      <span className={`font-size-base font-bold ${headerPanelStyle.logo}`} >PHAROS</span>
      <span className={`font-size-sm font-light ${headerPanelStyle.logoSub}`} >Clarity Across SAR and AIS</span>
      ...
      <div className={` ${headerPanelStyle.actions}`} >
        ...
        <span className={`font-size-xs ${headerPanelStyle.chip}`} onClick={toggleTheme}>
