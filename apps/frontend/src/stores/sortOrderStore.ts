...
import { ISortOrderStoreActions, ISortOrderStoreStates } from '../helpers/types/storeTypes';
...
export const useSortOrderStore = create<ISortOrderStoreStates & ISortOrderStoreActions>(
    combine(
        {
