export const samples: any = [
  {
    ...
    run_metadata: {
      config_hash:
        '0314e1e16dfb517da0146a1869a1e7ff67bc35ca92d45fbcbbbeb9af52486500',
      config_json: [
        {
...
export const headers = {
  ...
  'access-control-allow-headers':
    'Accept,Content-Type,cookie,refresh-token,Accept-Encoding,Authorization,origin,referer,user-agent,Access-Control-Allow-Origin,indexes-0,indexes-1,indexes-2,indexes-3,indexes-4,indexes-5,indexes-6,indexes-7,x-workspace-password',
  'access-control-allow-methods': 'GET,POST,PUT,PATCH,DELETE,OPTIONS',
  'access-control-allow-origin': '*',
  'access-control-expose-headers':
    'indexes-0,indexes-1,indexes-2,indexes-3,indexes-4,indexes-5,indexes-6,indexes-7,x-deprecated-dataset,x-ratelimit-daily-current-usage,x-ratelimit-daily-limit-requests,x-ratelimit-daily-remaining-requests,x-ratelimit-daily-reset-hours,x-ratelimit-monthly-current-usage,x-ratelimit-monthly-limit-requests,x-ratelimit-monthly-remaining-requests,x-ratelimit-monthly-reset-days, x-last-report-uri,x-rows,x-columns,x-offset,x-scale,x-empty-value,x-bins-0,x-bins-count-0',
  cache: 'true',
  ...
  'x-deprecated-dataset':
    'public-global-sar-presence:v3.0=public-global-sar-presence:v4.0',
