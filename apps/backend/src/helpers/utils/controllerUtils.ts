...
import { IResponse, IValidationErrorDetail, IValidationResult } from '@packages/types';
...
export const createErrorMessage = (a_ValidatioErrors: IValidationResult): EResponseError[] | undefined => {
