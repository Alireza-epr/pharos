...
export const FILTER_REASON_CODES_INCLUDE_CARGO_OR_MPA: IFilteringParams = {
    reason_codes_include: [EReasonCodesStatic.bathymetry_cargo_anomaly_zone, EReasonCodesStatic.inside_mpa],
}
...
export const FILTER_REASON_CODES_EXCLUDE_NEAR_COAST_AND_UNMATCHED: IFilteringParams = {
    reason_codes_exclude: [EReasonCodesStatic.near_coast, EReasonCodesStatic.unmatched_to_public_ais],
}
